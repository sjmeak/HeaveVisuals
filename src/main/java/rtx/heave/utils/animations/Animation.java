...
import rtx.heave.utils.animations.AnimationCalculation;
import rtx.heave.utils.animations.Direction;
import rtx.heave.utils.time.TimerUtil;
...
public class Animation implements AnimationCalculation {
    ...
    private double getProgress() {
        ...
        return Math.min(1.0, Math.max(0.0, (double)this.counter.getTime() / (double)this.ms));
    }
